...
public class ApiTest {
    ...
    static {
        GlobalConstant.ES_HOST = "https://www.zbth.com";
        GlobalConstant.KLINE_WS_HOST = "wss://kline.zbth.com";
        GlobalConstant.KLINE_HTTP_HOST = GlobalConstant.KLINE_WS_HOST.replaceFirst("wss", "https")
                .replaceFirst("ws", "http");

        //TODO:API_ID和API_SECRET请自行设置
        //测试环境id
        GlobalConstant.API_ID="your API ID";
        GlobalConstant.API_SECRET="your API SECRET";
    }
