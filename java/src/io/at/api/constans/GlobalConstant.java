...
public class GlobalConstant {
     ...
     * url 查询所有市场行情
     */
    public static final String API_GET_TICKERS= "/io/at/api/data/v1/tickers";

    /**
     * url 查询单个市场行情
     */
    public static final String API_GET_TICKER= "/io/at/api/data/v1/ticker";

    /**
     * url 查询k线列表
     */
    public static final String API_GET_KILNES= "/io/at/api/data/v1/klines";

    /**
     * url 查询交易记录
     */
    public static final String API_GET_TRADES= "/io/at/api/data/v1/trades";

    /**
     * url 获取盘口（市场深度）
     */
    public static final String API_GET_ENTRUSTS= "/io/at/api/data/v1/entrusts";
}
